...
const routes = [
    ...
    {
        path: 'load-app',
        loadChildren: () => __webpack_require__.e(/*! import() | load-app-load-app-module */ "load-app-load-app-module").then(__webpack_require__.bind(null, /*! ./load-app/load-app.module */ "./src/app/load-app/load-app.module.ts")).then(mod => mod.LoadAppModule)
    }
];
...
const _c0 = ["routerLink", "/", "src", "assets/img/logo.png", 2, "width", "3%"];
const _c1 = ["routerLink", "/", 2, "padding-left", "5px", "cursor", "pointer"];
const _c2 = [1, "example-fill-remaining-space"];
const _c3 = [2, "margin-left", "10px"];
const _c4 = [2, "width", "50px", "margin-left", "10px"];
const _c5 = [2, "width", "100%", "float", "right", 3, "src"];
const _c6 = [1, "container"];
const _c7 = ["mode", "side", "opened", ""];
const _c8 = [3, "emitItemSelected"];
class AppComponent {
...
/* harmony import */ var _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/material/sidenav */ "./node_modules/@angular/material/__ivy_ngcc__/esm2015/sidenav.js");
...
const _c0 = [1, "vertical-menu"];
const _c1 = [3, "click", 4, "ngFor", "ngForOf"];
const _c2 = [3, "click"];
function MenuComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextBinding"](2, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinterpolation1"]("", item_r5.icon, ""));
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵselect"](4);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextBinding"](4, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinterpolation1"](" ", item_r5.name, " "));
} }
class MenuComponent {
...
class MenuItem {
    constructor(cod, name, tag, pathApp, pathOption, icon) {
        this.cod = cod;
        this.name = name;
        this.tag = tag;
